...
<?php include('inc/header.php');?>
 ...
 <form action="edit-submitted-data.php" method = "POST" >
    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name ="update" >Create Profile</button></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">Skills Details</label><textarea class="form-control"  id="dark" rows="5" name="bio"  ></textarea></div> <br>
                <div class="col-md-12"><label class="labels">Your Bio</label><textarea class="form-control"  id="dark" rows="5" name="skills"></textarea></div>
            </div>
        </div>
    </div>
</div>
