...
<?php  
  $q=  "SELECT id , blogtitle, bloglink  FROM  users_blogs ";
              ...
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" id="home-tab" data-toggle="tab" href="#" role="tab" aria-selected="true">Subscribe</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" id="business-tab" data-toggle="tab" href="task.php" role="tab" aria-selected="false">Daily Task</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="channelModalLabel">Modal title</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
			  ...
			  <!-----div for modal ends------->
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Read The Blogs and Click on The Ads Shown </h4>
					<h6>*Read atleast 5 Minutes</h6>
					<style>
					h6{
						color:red;
					}
 ...
 <tr>
   ...
   <td><?php echo $data['id']; ?> </td>
    <td><?php echo $data['blogtitle']; ?> </td>
	    <td><a href = "<?php echo $data['bloglink']; ?> ">Read</a></td>
		  <!--td><?php echo "select getdate()"; ?> </td>
