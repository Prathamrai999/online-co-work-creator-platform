...
<?php  
  $q=  "SELECT id , videotitle, videolink  FROM  users_video ";
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
			  ...
			  <!-----div for modal ends------->
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Watch These Videos to Complete Your Daily Task</h4>
					<h6>*Atleast 5 Minutes For Each Videos</h6>
					<style>
					h6{
						color:red;
					}
 ...
 <tr>
   ...
   <td><?php echo $data['id']; ?> </td>
    <td><?php echo $data['videotitle']; ?> </td>
	    <td><a href = "<?php echo $data['videolink']; ?> ">Watch</a></td>
